...
(related) [bZx trading & borrowing doc](https://docs.bzx.network/fulcrum-integration/trading-borrowing) - helps you to understand the bZx attacks above
