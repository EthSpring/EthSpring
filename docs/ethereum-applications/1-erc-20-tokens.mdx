...
In workshop 1, we'll cover ERC-20 (how ICO works); decentralized exchange - Uniswap (how to swap ETH for some ERC-20 tokens); and stablecoin (DAI and USDC are all ERC-20 tokens).
