...
- They can run a _light node_, also known as a _light client_. Running a light node allows you to participate directly in the Ethereum network (sending transaction requests, reading blockchain data) without having hundreds of GB of free space, albeit in a limited fashion.
